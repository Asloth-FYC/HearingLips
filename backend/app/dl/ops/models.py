...
from app.dl.ops.basic_ops import ConsensusModule
    ...
    def _prepare_base_model(self, base_model):
        ...
        if 'resnet' in base_model:
            ...
            if self.is_shift:
                ...
                from app.dl.ops.temporal_shift import make_temporal_shift
                make_temporal_shift(self.base_model, self.num_segments,
                                    n_div=self.shift_div, place=self.shift_place, temporal_pool=self.temporal_pool)

            if self.non_local:
                print('Adding non-local module...')
                from app.dl.ops.non_local import make_non_local
            ...
            from app.dl.archs.mobilenet_v2 import mobilenet_v2, InvertedResidual
            ...
            self.base_model.avgpool = nn.AdaptiveAvgPool2d(1)
            if self.is_shift:
                from app.dl.ops.temporal_shift import TemporalShift
            ...
            from app.dl.archs.bn_inception import bninception
