...
from app.dl import opts
from app.dl.eco_dataset import TSNDataSet, TSNDataSet_infer
from app.dl.ops.models import TSN
from app.dl.ops.temporal_shift import make_temporal_pool
from app.dl.ops.transforms import *
from app.dl.ops.utils import AverageMeter, accuracy
from app.dl.opts import parser
...
def main():
    ...
    fr_r = open(opts.NUM_LABEL_R, 'r+', encoding='utf-8')
    w2n = eval(fr_r.read())
    fr_r.close()

    fr = open(opts.NUM_LABEL, 'r+', encoding='utf-8')
    n2w = eval(fr.read())
    fr.close()
    ...
    if args.mode != 'test':
        ...
        train_num = int(len(video_list) * 0.01)
